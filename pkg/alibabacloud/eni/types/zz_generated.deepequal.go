...
func (in *AlibabaCloudSpec) DeepEqual(other *AlibabaCloudSpec) bool {
	if other == nil {
		return false
	}
	...
	if ((in.VSwitchs != nil) && (other.VSwitchs != nil)) || ((in.VSwitchs == nil) != (other.VSwitchs == nil)) {
		in, other := &in.VSwitchs, &other.VSwitchs
		if other == nil {
			return false
		}
...
func (in *ENI) DeepEqual(other *ENI) bool {
	...
	if in.NetworkInterfaceName != other.NetworkInterfaceName {
		return false
	}
